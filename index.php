...
<html lang="<?php echo $lang; ?>">
  ...
  <body id="page">
    ...
    <div class="container">
      ...
      <button class="btn btn-info" onclick="toastr.info('Toastr werkt!');">Toastr Info Test</button>
      <button class="btn btn-warning" onclick="toastr.warning('Toastr werkt!');">Toastr Warning Test</button>
    </div>
